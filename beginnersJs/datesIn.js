...
let createdDate = new Date(1970, 9, 12) // 12/10/1970  yep, month = 10 because months start from [0 = January, if in single digit. Arrays my friend 🙂 ] in Js.
...
let anotherDate = new Date("2023-01-30") // format auto-converted( your compiler might not do that ) into dd/mm/yyyy 30/01/2023, 05:30:00 [and here we go, January = 1 using double digits]
